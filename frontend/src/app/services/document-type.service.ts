...
export class DocumentTypeService {
  ...
  fnHttpGetListDocumentTypesAdmin(token: string): Observable<any> {
    ...
    this.urlGetListDocumentTypes = 'tipoIdentificacion/listaTipoIdentificacionesAdmin';
    return this.http.get(this.utility.fnGetHost() + this.urlGetListDocumentTypes,
      {
        observe: 'response',
        headers: headers,
  ...
  fnHttpSetEditDocumentType(dataObject: any, id: any): Observable<any> {
    this.urlSetEditDocumentType = 'tipoIdentificacion/editarTipoIdentificacion/' + id;
  ...
  fnHttpSetDeleteDocumentType(dataObject: any, id: any): Observable<any> {
    this.urlSetDeleteDocumentType = 'tipoIdentificacion/inactivarTipoIdentificacion/' + id;
    return this.http.put(this.utility.fnGetHost() + this.urlSetDeleteDocumentType, dataObject, 
    {
      observe: 'response',
      reportProgress: true,
    });
